...
import * as exifModule from './exif.js';
const { imageToWebp, videoToWebp, writeExifImg, writeExifVid } = exifModule.default;

import * as stickerModule from './sticker.js';
const { imageToWebp: convImageToWebp, videoToWebp: convVideoToWebp, writeExifImg: convWriteExifImg, writeExifVid: convWriteExifVid } = stickerModule.default;

const __dirname = path.dirname(fileURLToPath(import.meta.url));

import * as baileysModule from '@adiwajshing/baileys';
const {
    makeWASocket,
    makeWALegacySocket,
    proto,
